(function (window, document) {
  ...
  function updatePlayPauseIcon() {
    if (video.paused) {
      playPausedButton.innerHTML = '<i class="fa fa-play"></i>';
    } else {
      playPausedButton.innerHTML = '<i class="fa fa-pause"></i>';
    }
  }

  function muteButtonClicked() {
    video.muted = !video.muted;
    if (video.muted) muteButton.innerHTML = '<i class="fa fa-volume-mute"></i>';
    else muteButton.innerHTML = '<i class="fa fa-volume-up"></i>';
  }
  ...
  function init() {
    ...
    playPausedButton.addEventListener("click", playPauseClicked);
